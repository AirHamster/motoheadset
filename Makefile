...
BUADRATE=921600
BUILD=docker
PROJECT_NAME := motoheadset
LOCAL_USER=$(id -u ${USER}):$(id -g ${USER})

SRC_DIR=${PWD}
IMG_NAME="motoheadset_firmware"
CONTAINER_NAME="motoheadset_firmware_work"
...
ota:
	python3 tools/imgtool.py  sign \
                              ...
                              --version 1.0.0 \
                              --pad-header \
                              build/motoheadset.bin build/motoheadset_signed.bin
